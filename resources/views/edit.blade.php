            ...
            <form class="form-horizontal" action="{{route('update',$student->id)}}" method="POST">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" value="{{$student->mobile_number}}" name="phone" placeholder="Phone">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" rows="2" name="address" id="textArea">{{$student->address}}</textarea>
